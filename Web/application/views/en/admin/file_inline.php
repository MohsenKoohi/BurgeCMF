...
<link href="{scripts_url}/roxy/css/jquery-ui-1.10.4.custom.min.css" rel="stylesheet" type="text/css" />
<link href="{scripts_url}/roxy/css/main.min.css" rel="stylesheet" type="text/css" />
  ...
  <tr>
   <td valign="top" class="pnlDirs" id="dirActions">
    ...
    <div id="pnlLoadingDirs">
       ...
       <img src="{scripts_url}/roxy/images/loading.gif" title="Loading directory tree, please wait...">
    </div>
    ...
    <div class="pnlFiles">
       <div class="scrollPane">
         <div id="pnlLoading">
          ...
          <img src="{scripts_url}/roxy/images/loading.gif" title="Loading files, please wait...">
          </div>
