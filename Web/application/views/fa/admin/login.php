	...
	<div class="container width-400">
		...
		<?php echo form_open(get_link("admin_login"),array()); ?>
			<div class="col12 columns mrg-btn-20">
				...
				<input class="ltr eng full-width" type="text" name="email" />
			</div>
			<div class="col12 columns mrg-btn-20">
				<label>{password_text}</label>
				<input class="ltr eng full-width" type="password" name="pass"/>
			</div>
			<div class="col12 columns mrg-btn-40">
				<labeL>{captcha}</label>
				<input class="ltr eng full-width" type="text" name="captcha" />
			</div>
